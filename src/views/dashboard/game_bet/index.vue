<template>
    ...
    <div v-loading="state.loading">
        <div class="head">游戏投注数据（根据厂家货币显示）</div>
...
const handleLookMore = () => {
    ...
    router.push(`/data-center/game-bet-data?startTime=${receiveTime && receiveTime.length ? receiveTime[0] : ''}&endTime=${receiveTime && receiveTime.length ? receiveTime[1] : ''}&merchantId=${merchantId || ''}`)
}
</script>
