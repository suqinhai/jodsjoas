    ...
    <div class="container accountManage">
        <el-tabs v-model="activeName" @tab-change="handleTabChange">
            <el-form class="filter-form" inline :model="state.searchData">
                ...
                <el-form-item>
                    <el-button v-throttle type="primary" @click="merchantFetchData('search')">搜 索</el-button>
                </el-form-item>
                <el-form-item>
                    <el-button v-throttle @click="merchantFetchData('reset')">重 置</el-button>
                </el-form-item>
            </el-form>
            <el-table class="table-box" :data="state.merchantTableData" border>
...
const merchantFetchData = (val = '') => {
    ...
    let params = { ...state.pageConfig, ...state.searchData, type:2 }
    globalVBus.$emit('globalLoading', true)
    getEmpList(params).then(res => {
        let { total, list = [] } = res.data
        state.merchantTableData = list
        state.total = total
